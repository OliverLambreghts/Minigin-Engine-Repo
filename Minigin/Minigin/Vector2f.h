...
struct Vector2f
{
	...
	explicit Vector2f( const utils::Point2f& fromPoint, const utils::Point2f& tillPoint );
	explicit Vector2f( const utils::Point2f& point );
	...
	Vector2f& operator-=( const Vector2f& rhs);
	explicit operator utils::Point2f(); 

	// -------------------------
	// Methods
	// -------------------------
	// Convert to Point2f	
	utils::Point2f	ToPoint2f( ) const;
...
utils::Point2f& operator+=(utils::Point2f& lhs, const Vector2f& rhs);
utils::Point2f operator+(utils::Point2f lhs, const Vector2f& rhs);
...
Vector2f operator-( const utils::Point2f& lhs, const utils::Point2f& rhs);
